...
`)},Yn=(e,t)=>{if(!e)return[];let n=e.split(/\r?\n/).map(e=>e.trim()).filter(Boolean);if(n.some(e=>e.startsWith(`RRULE`)))return n.filter(e=>e.startsWith(`RDATE`)||e.startsWith(`EXDATE`)).map(e=>fe(e,t));let r=n.find(e=>e.startsWith(`DTSTART`))?.split(`:`,2)[1]?.trim();return n.flatMap(e=>{if(!e.startsWith(`RDATE`)&&!e.startsWith(`EXDATE`))return[];if(!r||!e.startsWith(`RDATE`))return[fe(e,t)];let[n,i=``]=e.split(`:`,2),a=i.split(`,`).map(e=>e.trim()).filter(Boolean).filter(e=>e!==r);return a.length===0?[]:[fe(`${n}:${a.join(`,`)}`,t)]})},Xn=e=>{let t=l(e.start);return e.allDay?s(t):u(t)},Zn=[C.MO,C.TU,C.WE,C.TH,C.FR,C.SA,C.SU],Qn=(e,t)=>!e?.length||!t?e:e.map(e=>Zn[e]?.nth(t)).filter(Boolean),$n=(e,t)=>{let n=l(t);if(e.allDay)n.setHours(0,0,0,0);else{let t=l(e.start);n.setHours(t.getHours(),t.getMinutes(),t.getSeconds(),0)}return c(n)},er=new Set([`DAILY`,`WEEKLY`,`MONTHLY`,`YEARLY`,`CUSTOM`,`NEVER`]),tr=new Set([`NEVER`,`AFTER`,`ON_DATE`]),nr=e=>{if(!e)return{};let t=Array.isArray(e)?e:[e],n=[],r=new Set;return t.forEach(e=>{if(typeof e==`number`){n.push(e);return}n.push(e.weekday),typeof e.n==`number`&&r.add(e.n)}),{byweekday:n.length?n:void 0,bysetpos:r.size?Array.from(r):void 0}},rr=e=>er.has(e)?e:`NEVER`,ir=e=>tr.has(e)?e:`NEVER`,ar=e=>typeof e==`number`&&Number.isFinite(e)&&e>=1?e:1,or=kn({name:`event`,initialState:{start:Math.floor(Date.now()/1e3),end:Math.floor(Date.now()/1e3)+3600,until:void 0,allDay:!1,repeatType:`NEVER`,repeatEndType:`NEVER`,rrule:void 0,freq:S.DAILY,interval:1,count:void 0,byweekday:void 0,bymonth:void 0,bymonthday:void 0,byyearday:void 0,bysetpos:void 0},reducers:{setStart:(e,t)=>{let n=e.end-e.start,r=e.until?e.until-e.start:void 0;e.start=t.payload,e.end=e.start+n,e.until&&e.repeatEndType===`ON_DATE`&&(e.until=$n(e,e.until)),r!==void 0&&(e.until=e.start+r),G(e)},setEnd:(e,t)=>{e.end=t.payload},setUntil:(e,t)=>{let n=t.payload;n==null?e.until=void 0:e.until=$n(e,n),G(e)},setAllDay:(e,t)=>{let{enabled:n,eventDuration:r}=t.payload;e.allDay=n;let i=n?0:new Date().getUTCHours(),a=l(e.start);a.setHours(i,0,0,0),e.start=c(a);let o=l(e.end);n?o=se(b(o),1):(o=ee(o,1),o=_(o,a.getHours()),o=p(o,r)),e.end=c(o),e.until&&e.repeatEndType===`ON_DATE`&&(e.until=$n(e,e.until)),G(e)},setRepeatType:(e,t)=>{e.repeatType=t.payload,G(e)},setRepeatEndType:(e,t)=>{let n=t.payload;e.repeatEndType=n,n===`AFTER`?e.count=ar(e.count):e.count=null,G(e)},setFreq:(e,t)=>{e.freq=t.payload,Un(e,t.payload),G(e)},setCount:(e,t)=>{e.count=ar(t.payload),G(e)},setInterval:(e,t)=>{e.interval=Math.max(1,t.payload),G(e)},setDays:(e,t)=>{let{type:n,values:r}=t.payload;e[n]=W(r),G(e)},setByRules:(e,t)=>{let n=t.payload;`byweekday`in n&&(e.byweekday=W(n.byweekday)),`bymonth`in n&&(e.bymonth=W(n.bymonth)),`bymonthday`in n&&(e.bymonthday=W(n.bymonthday)),`byyearday`in n&&(e.byyearday=W(n.byyearday)),`bysetpos`in n&&(e.bysetpos=W(n.bysetpos)),G(e)},setRRule:(e,t)=>{e.rrule=t.payload||void 0}}}),{actions:K}=or,sr=or.reducer,q={state:e=>e.event},cr=kn({name:`app`,initialState:{pro:!1},reducers:{}}),{actions:lr}=cr,ur=cr.reducer,J={config:e=>e.app,isPro:e=>e.app.pro,formats:e=>e.app.formats,weekStartDay:e=>e.app.weekStartDay??0,timeInterval:e=>e.app.timeInterval??30,eventDuration:e=>e.app.eventDuration??60,allDayDefault:e=>e.app.allDayDefault??!1,overlapThreshold:e=>e.app.overlapThreshold??0},dr=e=>{let t=new Map(e.map(e=>[e.getTime(),e])).values();return Array.from(t).sort((e,t)=>e.getTime()-t.getTime())},fr=e=>c(b(l(e))),pr=t=>c(b(e(t))),mr=e=>new Date(Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate(),0,0,0,0)),hr=e=>new Date(Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate(),23,59,59,999)),gr=e=>Math.floor(mr(e).getTime()/1e3),_r=(e,t)=>{let n=fr(t),r=he(e)??null,i=pe(e);return{startTimestamp:n,baseRule:r,recurrenceSet:i,addedDateSet:new Set((i?.rdates()??[]).map(pr).filter(e=>r?!0:e!==n))}},vr=(e,t)=>{let n=gr(t),r=mr(t),i=hr(t),a=e.baseRule?e.baseRule.between(r,i,!0).length>0:!1,o=e.recurrenceSet?e.recurrenceSet.between(r,i,!0).length>0:n===e.startTimestamp;return{timestamp:n,full:o,base:a,excluded:a&&!o,rdate:e.addedDateSet.has(n)}},yr=(e,t)=>{if(!t)return[];let n=mr(t.start),r=hr(t.end),i=gr(t.start),o=gr(t.end),s=[];return e.recurrenceSet?s=e.recurrenceSet.between(n,r,!0).map(pr):e.startTimestamp>=i&&e.startTimestamp<=o&&(s=[e.startTimestamp]),Array.from(new Set(s)).map(e=>({id:a(new Date(e*1e3)),start:y(l(e),`yyyy-MM-dd`),allDay:!0}))},br=(e,t,n)=>{if(!t)return[];if(!e.recurrenceSet){let n=gr(t);return e.startTimestamp>=n?[e.startTimestamp]:[]}let r=e.recurrenceSet.between(mr(t),te(hr(t),100),!0,(e,t)=>t<n).map(pr);return Array.from(new Set(r)).slice(0,n)},xr=(e,t,n,r,i)=>{let a=Gn(e,r),o=a.getTime(),s=Sr(t,({baseRule:e,rdates:t,exdates:r})=>({baseRule:e,rdates:Cr(t,a,o,n===`rdate`,i),exdates:Cr(r,a,o,n===`exdate`,i)}));return Kn(e,s.baseRule,dr(s.rdates),dr(s.exdates))},Sr=(e,t)=>t({baseRule:e.baseRule,rdates:wr(e),exdates:e.recurrenceSet?.exdates()??[]}),Cr=(e,t,n,r,i)=>r?i?[...e,t]:e.filter(e=>e.getTime()!==n):e,wr=e=>{let t=e.recurrenceSet?.rdates()??[];return e.baseRule?t:t.filter(t=>pr(t)!==e.startTimestamp)},Tr=d.div`
  flex: 2;
...
`,Y=n(),kr=8,Ar=()=>{let e=D(),t=O(q.state),{repeatType:n,start:r,rrule:i}=t,[o,s]=(0,T.useState)(null),c=(0,T.useMemo)(()=>_r(i,r),[i,r]),l=(0,T.useMemo)(()=>yr(c,o),[c,o]),u=(0,T.useMemo)(()=>br(c,o?.start??null,kr),[c,o]),d=(0,T.useCallback)((n,r,i)=>{e(K.setRRule(xr(t,c,n,r,i)))},[e,c,t]),p=(0,T.useCallback)(e=>{let t=vr(c,e);if(t.base&&t.excluded){d(`exdate`,t.timestamp,!1);return}if(t.base&&t.full&&n!==`NEVER`){d(`exdate`,t.timestamp,!0);return}if(!t.base&&t.full&&t.rdate){d(`rdate`,t.timestamp,!1);return}t.full||d(`rdate`,t.timestamp,!0)},[d,c,n]),m=(0,T.useCallback)(e=>vr(c,e),[c]);return(0,Y.jsxs)(Tr,{children:[(0,Y.jsx)(ae,{label:`Recurrence Preview`,children:(0,Y.jsx)(le,{aspectRatio:2,height:250,expandRows:!1,themeSystem:`bootstrap5`,plugins:[ce,ue],initialView:`dayGridMonth`,timeZone:`UTC`,eventDisplay:`none`,events:l,headerToolbar:{start:`title`,end:`prev,today,next`},datesSet:e=>s({start:e.start,end:e.end}),dayCellClassNames:e=>{let t=m(e.date);return[t.full?`fc-has-event`:``,t.rdate?`fc-extra-date`:``,t.excluded?`fc-excluded-date`:``].filter(Boolean)},dateClick:e=>p(e.date)})}),(0,Y.jsx)(Er,{children:u.length===0?(0,Y.jsxs)(`p`,{children:[f(`No occurrences starting from`),(0,Y.jsx)(`br`,{}),y(o?.start||new Date,`PP`)]}):(0,Y.jsx)(Dr,{$count:u.length,children:u.map(e=>{let t=a(new Date(e*1e3));return(0,Y.jsx)(Or,{children:t},t)})})})]})},jr=d.div`
...
`,Di=({title:e,actionLabel:t,actionClass:n,popoverTitle:r,dates:i,openToDate:a,weekStartDay:o,formatDate:s,filterDate:l,onAdd:u,onRemove:d})=>{let[p,m]=(0,T.useState)(!1),h=(0,T.useRef)(null),_=(0,T.useRef)(null);return(0,T.useEffect)(()=>{i.length===0&&m(!1)},[i.length]),hi(p,[h,_],()=>m(!1)),(0,Y.jsxs)(gi,{children:[(0,Y.jsx)(_i,{children:f(e)}),(0,Y.jsxs)(vi,{children:[(0,Y.jsxs)(xi,{children:[(0,Y.jsx)(Si,{ref:h,type:`button`,disabled:i.length===0,className:x({active:p}),onClick:()=>{i.length!==0&&m(e=>!e)},children:i.length}),p&&(0,Y.jsxs)(Ci,{ref:_,children:[(0,Y.jsx)(wi,{children:f(r)}),(0,Y.jsx)(Ti,{children:i.map(e=>(0,Y.jsxs)(Ei,{children:[(0,Y.jsx)(`span`,{children:s(e)}),(0,Y.jsx)(`button`,{type:`button`,onClick:()=>d(e),children:`×`})]},e))})]})]}),(0,Y.jsx)(yi,{children:(0,Y.jsx)(g,{selected:null,onChange:e=>{e&&u(c(b(e)))},customInput:(0,Y.jsx)(Oi,{label:t,className:x(`btn`,n)}),shouldCloseOnSelect:!0,showTimeSelect:!1,showMonthDropdown:!0,showYearDropdown:!0,dropdownMode:`select`,todayButton:f(`Today`),openToDate:a,calendarStartDay:o,filterDate:l})})]})]})},Oi=(0,T.forwardRef)(({label:e,...t},n)=>(0,Y.jsx)(bi,{type:`button`,ref:n,...t,children:f(e)}));Oi.displayName=`PickerTrigger`;var ki=d.div`
  flex: 1;
`,Ai=()=>{let t=D(),n=O(q.state),{start:r,rrule:i}=n,a=(0,T.useMemo)(()=>c(b(l(r))),[r]),o=(0,T.useMemo)(()=>he(i)??null,[i]),d=(0,T.useMemo)(()=>pe(i),[i]),f=(0,T.useMemo)(()=>d?Array.from(new Set(d.rdates().map(t=>c(b(e(t)))).filter(e=>o?!0:e!==a))).sort((e,t)=>e-t):[],[o,d,a]),p=(0,T.useMemo)(()=>d?Array.from(new Set(d.exdates().map(t=>c(b(e(t)))))).sort((e,t)=>e-t):[],[d]),m=(0,T.useMemo)(()=>new Set(f),[f]),h=(0,T.useMemo)(()=>new Set(p),[p]),g=(0,T.useCallback)(e=>{let t=s(b(e)),n=u(ne(e)),r=o?o.between(t,n,!0).length>0:!1,i=d?d.between(t,n,!0).length>0:c(b(e))===a;return{full:i,base:r,excluded:r&&!i}},[o,d,a]),_=r=>{let i=r({baseRule:o,rdates:d?.rdates().filter(t=>o?!0:c(b(e(t)))!==a)??[],exdates:d?.exdates()??[]});t(K.setRRule(Kn(n,i.baseRule,ji(i.rdates),ji(i.exdates))))};return{addedDates:f,excludedDates:p,addFixedDate:(e,t)=>{let r=Gn(n,t);_(({baseRule:t,rdates:n,exdates:i})=>({baseRule:t,rdates:e===`rdate`?[...n,r]:n,exdates:e===`exdate`?[...i,r]:i}))},removeFixedDate:(e,t)=>{let r=Gn(n,t).getTime();_(({baseRule:t,rdates:n,exdates:i})=>({baseRule:t,rdates:e===`rdate`?n.filter(e=>e.getTime()!==r):n,exdates:e===`exdate`?i.filter(e=>e.getTime()!==r):i}))},canAddOccurrence:(0,T.useCallback)(e=>{let t=c(b(e)),n=g(e);return!n.full&&!n.excluded&&!m.has(t)},[m,g]),canExcludeOccurrence:(0,T.useCallback)(e=>{let t=c(b(e)),n=g(e);return n.base&&!n.excluded&&!h.has(t)},[h,g]),getStatus:g}},ji=e=>{let t=new Map(e.map(e=>[e.getTime(),e])).values();return Array.from(t).sort((e,t)=>e.getTime()-t.getTime())},Mi=[{value:`NEVER`,label:`Never`},{value:`DAILY`,label:`Every Day`},{value:`WEEKLY`,label:`Every Week`},{value:`MONTHLY`,label:`Every Month`},{value:`YEARLY`,label:`Every Year`},{value:`CUSTOM`,label:`Custom...`}],Ni=[{value:`NEVER`,label:`Never`},{value:`AFTER`,label:`After...`},{value:`ON_DATE`,label:`On Date...`}],Pi=[{value:S.DAILY,label:`Daily`},{value:S.WEEKLY,label:`Weekly`},{value:S.MONTHLY,label:`Monthly`},{value:S.YEARLY,label:`Yearly`}],Fi=300,Ii=()=>{let e=D(),t=O(q.state),n=O(J.weekStartDay),{repeatType:r,repeatEndType:i,count:a,until:o,freq:s,start:c}=t,u=r!==`NEVER`,{addedDates:d,excludedDates:f,addFixedDate:p,removeFixedDate:h,canAddOccurrence:g,canExcludeOccurrence:_}=Ai(),ee=(0,T.useMemo)(()=>l(c),[c]),te=e=>y(l(e),`yyyy-MM-dd`);return(0,Y.jsxs)(ki,{children:[(0,Y.jsxs)(oe,{children:[(0,Y.jsx)(w,{label:`Repeat`,value:r,options:Mi,onChange:t=>e(K.setRepeatType(t))}),r===`CUSTOM`&&(0,Y.jsx)(w,{label:``,value:s,options:Pi,onChange:t=>e(K.setFreq(Number.parseInt(t,10)))})]}),r===`CUSTOM`&&(0,Y.jsx)(`div`,{className:`field`,children:(0,Y.jsx)(mi,{})}),r!==`NEVER`&&(0,Y.jsxs)(oe,{className:`field`,children:[(0,Y.jsx)(w,{label:`Repeat End`,options:Ni,value:i,onChange:t=>e(K.setRepeatEndType(t))}),i===`AFTER`&&(0,Y.jsx)(zr,{label:`Times`,value:a,min:1,debounceMs:Fi,onChange:t=>e(K.setCount(t))}),i===`ON_DATE`&&(0,Y.jsx)(m,{label:``,value:o||null,onChange:t=>e(K.setUntil(t)),datePickerProps:{showTimeInput:!1,calendarStartDay:n}})]}),(0,Y.jsx)(Di,{title:`Custom Occurrences`,actionLabel:`Add Occurrence`,actionClass:`icon add dashed`,popoverTitle:`Added Occurrences`,dates:d,openToDate:ee,formatDate:te,filterDate:g,weekStartDay:n,onAdd:e=>p(`rdate`,e),onRemove:e=>h(`rdate`,e)}),u&&(0,Y.jsx)(Di,{title:`Exceptions`,actionLabel:`Exclude Occurrence`,actionClass:`icon dashed minus`,popoverTitle:`Excluded Occurrences`,dates:f,openToDate:ee,formatDate:te,filterDate:_,weekStartDay:n,onAdd:e=>p(`exdate`,e),onRemove:e=>h(`exdate`,e)})]})},Li=()=>{let e=(0,T.useId)(),t=(0,T.useId)(),n=(0,T.useId)(),r=D(),{start:i,end:a,allDay:o}=O(q.state),{date:s,time:c,datetime:u}=O(J.formats),d=O(J.weekStartDay),p=O(J.timeInterval),h=O(J.eventDuration),g=(0,T.useMemo)(()=>o?s.short.icu:u.short.icu,[o,s,u]),_=(0,T.useMemo)(()=>o?Mr(a):a,[o,a]);return(0,Y.jsxs)(jr,{children:[(0,Y.jsxs)(`div`,{style:{flex:1},children:[(0,Y.jsx)(re,{id:e,label:`All Day`,enabled:o,onClick:e=>r(K.setAllDay({enabled:e,eventDuration:h}))}),(0,Y.jsx)(m,{id:t,label:`Starts`,value:i,onChange:e=>r(K.setStart(e)),datePickerProps:{id:t,showIcon:!0,icon:(0,Y.jsx)(ie,{}),toggleCalendarOnIconClick:!0,showTimeSelect:!o,showMonthDropdown:!0,showYearDropdown:!0,dropdownMode:`select`,dateFormat:g,timeFormat:c.short.icu,todayButton:f(`Today`),calendarStartDay:d,timeIntervals:p}}),(0,Y.jsx)(m,{id:n,label:`Ends`,value:_,onChange:e=>{e!=null&&r(K.setEnd(Pr({value:e,start:i,allDay:o,timeInterval:p})))},datePickerProps:{id:n,showIcon:!0,icon:(0,Y.jsx)(ie,{}),toggleCalendarOnIconClick:!0,minDate:l(i),showTimeSelect:!o,showMonthDropdown:!0,showYearDropdown:!0,dropdownMode:`select`,dateFormat:g,timeFormat:c.short.icu,todayButton:f(`Today`),calendarStartDay:d,timeIntervals:p,filterTime:e=>Nr(new Date(e),i,p)}})]}),(0,Y.jsx)(Ii,{}),(0,Y.jsx)(Ar,{})]})},Ri=d.div`
  code {
    display: block;
    padding: 12px;
    background-color: var(--gray-100);
