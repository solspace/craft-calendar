...
`,Ti=()=>{let{rrule:e}=O(q.state),t=(0,T.useMemo)(Be,[]),n=e?me(e,{forceset:!0}).all((e,t)=>t<10).map(e=>`${v(c(e),`yyyy-MM-dd HH:mm`)} [${ge(e)}]`):[];return(0,Y.jsxs)(wi,{children:[(0,Y.jsx)(Ci,{}),t&&(0,Y.jsxs)(`code`,{children:[(0,Y.jsx)(`pre`,{children:e}),(0,Y.jsx)(`pre`,{children:JSON.stringify(n,null,2)})]})]})},Ei=(e,t)=>{let{start:n,end:r,until:i,timezone:a,allDay:o,rrule:s,repeatType:c,repeatEndType:l}=e.getState().event;$(t,`start`,Di(n)),$(t,`end`,Di(r)),$(t,`until`,i?Di(i):``),$(t,`timezone`,a||`UTC`),$(t,`allDay`,o?`1`:`0`),$(t,`repeatType`,c??`NEVER`),$(t,`repeatEndType`,l??`NEVER`),$(t,`rrule`,s??``)},Di=e=>v(o(e),`yyyy-MM-dd'T'HH:mm:ss`),$=(e,t,n)=>{let r=e.querySelector(`input[name="${t}"]`);if(!r)return;let i=n.toString();r.value!==i&&(r.value=i,r.dispatchEvent(new Event(`input`,{bubbles:!0})),r.dispatchEvent(new Event(`change`,{bubbles:!0})))},Oi=e=>{if(!e)return{};let t=Array.isArray(e)?e:[e],n=[],r=new Set;return t.forEach(e=>{if(typeof e==`number`){n.push(e);return}n.push(e.weekday),typeof e.n==`number`&&r.add(e.n)}),{byweekday:n.length?n:void 0,bysetpos:r.size?Array.from(r):void 0}},ki=e=>{let t=he(e.event.rrule),{byweekday:n,bysetpos:r}=Oi(t?.options.byweekday),i={app:e.app,event:{start:e.event.start,end:e.event.end,until:e.event.until,timezone:e.event.timezone,allDay:e.event.allDay,repeatType:e.event.repeatType,repeatEndType:e.event.repeatEndType,rrule:e.event.rrule,freq:t?.options.freq||S.DAILY,interval:t?.options.interval||1,count:t?.options.count||null,byweekday:n,bymonth:t?.options.bymonth,bymonthday:t?.options.bymonthday,byyearday:t?.options.byyearday,bysetpos:t?.options.bysetpos??r}};return xn({reducer:{app:ir,event:tr},preloadedState:i})},Ai=new WeakSet,ji=e=>{if(Ai.has(e))return;Ai.add(e),e.dataset.eventBuilderMounted=`true`;let t=e.querySelector(`script[data-config]`),n=e.querySelector(`div[data-root]`),r=ki(JSON.parse(t.textContent)),i=ye.createRoot(n);r.subscribe(()=>{Ei(r,e)}),Ei(r,e),i.render((0,Y.jsx)(Me,{store:r,children:(0,Y.jsx)(Ti,{})}))},Mi=(e=document)=>{e.querySelectorAll(`[data-event-builder]:not([data-event-builder-mounted])`).forEach(ji)},Ni=()=>{Mi(),new MutationObserver(e=>{e.forEach(e=>{e.addedNodes.forEach(e=>{e instanceof HTMLElement&&(e.matches(`[data-event-builder]`)&&ji(e),Mi(e))})})}).observe(document.documentElement,{childList:!0,subtree:!0})};document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Ni):Ni();