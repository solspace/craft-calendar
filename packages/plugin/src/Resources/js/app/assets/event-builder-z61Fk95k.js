...
`)},Yn=(e,t)=>{if(!e)return[];let n=e.split(/\r?\n/).map(e=>e.trim()).filter(Boolean);if(n.some(e=>e.startsWith(`RRULE`)))return n.filter(e=>e.startsWith(`RDATE`)||e.startsWith(`EXDATE`)).map(e=>fe(e,t));let r=n.find(e=>e.startsWith(`DTSTART`))?.split(`:`,2)[1]?.trim();return n.flatMap(e=>{if(!e.startsWith(`RDATE`)&&!e.startsWith(`EXDATE`))return[];if(!r||!e.startsWith(`RDATE`))return[fe(e,t)];let[n,i=``]=e.split(`:`,2),a=i.split(`,`).map(e=>e.trim()).filter(Boolean).filter(e=>e!==r);return a.length===0?[]:[fe(`${n}:${a.join(`,`)}`,t)]})},Xn=e=>{let t=o(e.start);return e.allDay?a(t):l(t)},Zn=[C.MO,C.TU,C.WE,C.TH,C.FR,C.SA,C.SU],Qn=(e,t)=>!e?.length||!t?e:e.map(e=>Zn[e]?.nth(t)).filter(Boolean),$n=(e,t)=>{let n=o(t);if(e.allDay)n.setHours(0,0,0,0);else{let t=o(e.start);n.setHours(t.getHours(),t.getMinutes(),t.getSeconds(),0)}return s(n)},er=kn({name:`event`,initialState:{start:Math.floor(Date.now()/1e3),end:Math.floor(Date.now()/1e3)+3600,until:void 0,allDay:!1,repeatType:`NEVER`,repeatEndType:`NEVER`,rrule:void 0,freq:S.DAILY,interval:1,count:void 0,byweekday:void 0,bymonth:void 0,bymonthday:void 0,byyearday:void 0,bysetpos:void 0},reducers:{setStart:(e,t)=>{let n=e.end-e.start,r=e.until?e.until-e.start:void 0;e.start=t.payload,e.end=e.start+n,e.until&&e.repeatEndType===`ON_DATE`&&(e.until=$n(e,e.until)),r!==void 0&&(e.until=e.start+r),G(e)},setEnd:(e,t)=>{e.end=t.payload},setUntil:(e,t)=>{let n=t.payload;n==null?e.until=void 0:e.until=$n(e,n),G(e)},setAllDay:(e,t)=>{let{enabled:n,eventDuration:r}=t.payload;e.allDay=n;let i=n?0:new Date().getUTCHours(),a=o(e.start);a.setHours(i,0,0,0),e.start=s(a);let c=o(e.end);n?c=se(m(c),1):(c=_(c,1),c=u(c,a.getHours()),c=ee(c,r)),e.end=s(c),e.until&&e.repeatEndType===`ON_DATE`&&(e.until=$n(e,e.until)),G(e)},setRepeatType:(e,t)=>{e.repeatType=t.payload,G(e)},setRepeatEndType:(e,t)=>{let n=t.payload;e.repeatEndType=n,n!==`AFTER`&&(e.count=null),G(e)},setFreq:(e,t)=>{e.freq=t.payload,Un(e,t.payload),G(e)},setCount:(e,t)=>{e.count=t.payload,G(e)},setInterval:(e,t)=>{e.interval=Math.max(1,t.payload),G(e)},setDays:(e,t)=>{let{type:n,values:r}=t.payload;e[n]=W(r),G(e)},setByRules:(e,t)=>{let n=t.payload;`byweekday`in n&&(e.byweekday=W(n.byweekday)),`bymonth`in n&&(e.bymonth=W(n.bymonth)),`bymonthday`in n&&(e.bymonthday=W(n.bymonthday)),`byyearday`in n&&(e.byyearday=W(n.byyearday)),`bysetpos`in n&&(e.bysetpos=W(n.bysetpos)),G(e)},setRRule:(e,t)=>{e.rrule=t.payload||void 0}}}),{actions:K}=er,tr=er.reducer,q={state:e=>e.event},nr=kn({name:`app`,initialState:{pro:!1},reducers:{}}),{actions:rr}=nr,ir=nr.reducer,J={config:e=>e.app,isPro:e=>e.app.pro,formats:e=>e.app.formats,weekStartDay:e=>e.app.weekStartDay??0,timeInterval:e=>e.app.timeInterval??30,eventDuration:e=>e.app.eventDuration??60,allDayDefault:e=>e.app.allDayDefault??!1,overlapThreshold:e=>e.app.overlapThreshold??0},ar=e=>{let t=new Map(e.map(e=>[e.getTime(),e])).values();return Array.from(t).sort((e,t)=>e.getTime()-t.getTime())},or=e=>s(m(o(e))),sr=e=>s(m(c(e))),cr=e=>new Date(Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate(),0,0,0,0)),lr=e=>new Date(Date.UTC(e.getUTCFullYear(),e.getUTCMonth(),e.getUTCDate(),23,59,59,999)),ur=e=>Math.floor(cr(e).getTime()/1e3),dr=(e,t)=>{let n=or(t),r=he(e)??null,i=pe(e);return{startTimestamp:n,baseRule:r,recurrenceSet:i,addedDateSet:new Set((i?.rdates()??[]).map(sr).filter(e=>r?!0:e!==n))}},fr=(e,t)=>{let n=ur(t),r=cr(t),i=lr(t),a=e.baseRule?e.baseRule.between(r,i,!0).length>0:!1,o=e.recurrenceSet?e.recurrenceSet.between(r,i,!0).length>0:n===e.startTimestamp;return{timestamp:n,full:o,base:a,excluded:a&&!o,rdate:e.addedDateSet.has(n)}},pr=(e,t)=>{if(!t)return[];let n=cr(t.start),r=lr(t.end),a=ur(t.start),s=ur(t.end),c=[];return e.recurrenceSet?c=e.recurrenceSet.between(n,r,!0).map(sr):e.startTimestamp>=a&&e.startTimestamp<=s&&(c=[e.startTimestamp]),Array.from(new Set(c)).map(e=>({id:i(new Date(e*1e3)),start:v(o(e),`yyyy-MM-dd`),allDay:!0}))},mr=(e,t,n)=>{if(!t)return[];if(!e.recurrenceSet){let n=ur(t);return e.startTimestamp>=n?[e.startTimestamp]:[]}let r=e.recurrenceSet.between(cr(t),te(lr(t),100),!0,(e,t)=>t<n).map(sr);return Array.from(new Set(r)).slice(0,n)},hr=(e,t,n,r,i)=>{let a=Gn(e,r),o=a.getTime(),s=gr(t,({baseRule:e,rdates:t,exdates:r})=>({baseRule:e,rdates:_r(t,a,o,n===`rdate`,i),exdates:_r(r,a,o,n===`exdate`,i)}));return Kn(e,s.baseRule,ar(s.rdates),ar(s.exdates))},gr=(e,t)=>t({baseRule:e.baseRule,rdates:vr(e),exdates:e.recurrenceSet?.exdates()??[]}),_r=(e,t,n,r,i)=>r?i?[...e,t]:e.filter(e=>e.getTime()!==n):e,vr=e=>{let t=e.recurrenceSet?.rdates()??[];return e.baseRule?t:t.filter(t=>sr(t)!==e.startTimestamp)},yr=p.div`
  flex: 2;
...
`,Pr=()=>(0,Y.jsx)(kr,{noun:`day`}),X=[{value:`MO`,label:`Monday`,days:[C.MO.weekday]},{value:`TU`,label:`Tuesday`,days:[C.TU.weekday]},{value:`WE`,label:`Wednesday`,days:[C.WE.weekday]},{value:`TH`,label:`Thursday`,days:[C.TH.weekday]},{value:`FR`,label:`Friday`,days:[C.FR.weekday]},{value:`SA`,label:`Saturday`,days:[C.SA.weekday]},{value:`SU`,label:`Sunday`,days:[C.SU.weekday]},{value:`WD`,label:`Weekday (Mon-Fri)`,days:[C.MO.weekday,C.TU.weekday,C.WE.weekday,C.TH.weekday,C.FR.weekday]},{value:`WEK`,label:`Weekend Day (Sat/Sun)`,days:[C.SA.weekday,C.SU.weekday]}],Fr=e=>{if(!(!e||e.length===0))return Array.from(new Set(e)).sort((e,t)=>e-t)},Ir=(e,t)=>{let n=Fr(e),r=Fr(t);return!n||!r||n.length!==r.length?!1:n.every((e,t)=>e===r[t])},Lr=(e,t)=>{if(e){let t=X.find(t=>Ir(t.days,e));if(t)return t.value}if(t!==void 0){let e=X.find(e=>e.days.length===1&&e.days[0]===t);if(e)return e.value}return X[0].value},Rr=e=>X.find(t=>t.value===e)?.days??[C.MO.weekday],Z=`5px`,Q=p.button`
  width: 100%;
  padding: 0.5rem;
...
`,Gr=({label:e,values:t,onChange:n})=>(0,Y.jsx)(ae,{label:e,children:(0,Y.jsxs)(Hr,{children:[Array.from({length:31},(e,t)=>t+1).map(e=>(0,Y.jsx)(zr,{type:`button`,className:y(t.includes(e)&&`active`),onClick:()=>{let r=t.filter(t=>t!==e);t.includes(e)||(r=[...r,e]),r.length!==0&&(r.sort((e,t)=>e-t),n(r))},children:e},e)),Array.from({length:4},(e,t)=>t+1).map(e=>(0,Y.jsx)(Br,{},e))]})}),Kr=[{value:`MONTHDAY`,label:`On day of month`},{value:`WEEKDAY`,label:`On the nth weekday`}],qr=[{value:1,label:`First`},{value:2,label:`Second`},{value:3,label:`Third`},{value:4,label:`Fourth`},{value:-1,label:`Last`}],Jr=()=>{let e=D(),{start:t,bymonthday:n,byweekday:r,bysetpos:i}=O(q.state),a=o(t),s=a.getDate(),c=(a.getDay()+6)%7,l=i?.length&&r?.length?`WEEKDAY`:`MONTHDAY`,u=n?.length?n:[s],d=i?.[0]??1,f=Lr(r,c),p=t=>{e(K.setByRules({bymonthday:t.length?t:void 0,byweekday:void 0,bysetpos:void 0}))},m=(t,n)=>{e(K.setByRules({bymonthday:void 0,byweekday:Rr(t),bysetpos:[n]}))};return(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(kr,{noun:`month`}),(0,Y.jsx)(`div`,{className:`field`,children:(0,Y.jsx)(w,{label:`Repeat On`,value:l,options:Kr,onChange:e=>{e===`WEEKDAY`?m(f,d):p(u)}})}),l===`MONTHDAY`&&(0,Y.jsx)(Gr,{label:`Days of month`,values:u,onChange:e=>p(e)}),l===`WEEKDAY`&&(0,Y.jsxs)(oe,{className:`field`,children:[(0,Y.jsx)(w,{label:`Position`,value:d,options:qr,onChange:e=>m(f,Number.parseInt(e,10))}),(0,Y.jsx)(w,{label:`Day`,value:f,options:X.map(e=>({value:e.value,label:e.label})),onChange:e=>m(e,d)})]})]})},Yr=[C.MO,C.TU,C.WE,C.TH,C.FR,C.SA,C.SU],Xr=()=>{let e=D(),{byweekday:t}=O(q.state);return(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(kr,{noun:`week`}),(0,Y.jsx)(Ur,{className:`field`,children:Yr.map(n=>(0,Y.jsx)(zr,{type:`button`,className:y(t?.includes(n.weekday)&&`active`),onClick:()=>{let r=t?[...t]:[];r.includes(n.weekday)?r=r.filter(e=>e!==n.weekday):r.push(n.weekday),r.length!==0&&e(K.setDays({type:`byweekday`,values:r}))},children:n.toString()},n.weekday))})]})},Zr=[{value:`MONTHDAY`,label:`On specific date`},{value:`WEEKDAY`,label:`On the nth weekday`}],Qr=[{value:1,label:`First`},{value:2,label:`Second`},{value:3,label:`Third`},{value:4,label:`Fourth`},{value:-1,label:`Last`}],$r=[{value:1,label:`January`},{value:2,label:`February`},{value:3,label:`March`},{value:4,label:`April`},{value:5,label:`May`},{value:6,label:`June`},{value:7,label:`July`},{value:8,label:`August`},{value:9,label:`September`},{value:10,label:`October`},{value:11,label:`November`},{value:12,label:`December`}],ei=()=>{let e=D(),{start:t,bymonth:n,bymonthday:r,byweekday:i,bysetpos:a}=O(q.state),s=o(t),c=s.getDate(),l=s.getMonth()+1,u=(s.getDay()+6)%7,d=a?.length&&i?.length?`WEEKDAY`:`MONTHDAY`,f=r?.length?r:[c],p=n?.length?n:[l],m=a?.[0]??1,h=Lr(i,u),g=(t,n)=>{e(K.setByRules({bymonth:t.length?t:void 0,bymonthday:n.length?n:void 0,byweekday:void 0,bysetpos:void 0}))},_=(t,n,r)=>{e(K.setByRules({bymonth:t.length?t:void 0,bymonthday:void 0,byweekday:Rr(n),bysetpos:[r]}))};return(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(kr,{noun:`year`}),(0,Y.jsx)(ae,{label:`Month`,children:(0,Y.jsx)(Wr,{children:$r.map(e=>{let t=p.includes(e.value);return(0,Y.jsx)(zr,{type:`button`,className:y(t&&`active`),onClick:()=>{let n=p.filter(t=>t!==e.value);t||(n=[...n,e.value]),n.length!==0&&(n.sort((e,t)=>e-t),d===`WEEKDAY`?_(n,h,m):g(n,f))},children:e.label},e.value)})})}),(0,Y.jsx)(`div`,{className:`field`,children:(0,Y.jsx)(w,{label:`Repeat On`,value:d,options:Zr,onChange:e=>{e===`WEEKDAY`?_(p,h,m):g(p,f)}})}),d===`MONTHDAY`&&(0,Y.jsx)(Gr,{label:`Days of month`,values:f,onChange:e=>g(p,e)}),d===`WEEKDAY`&&(0,Y.jsxs)(oe,{className:`field`,children:[(0,Y.jsx)(w,{label:`Position`,value:m,options:Qr,onChange:e=>_(p,h,Number.parseInt(e,10))}),(0,Y.jsx)(w,{label:`Day`,value:h,options:X.map(e=>({value:e.value,label:e.label})),onChange:e=>_(p,e,m)})]})]})},ti=()=>{let{freq:e}=O(q.state);return e===S.DAILY?(0,Y.jsx)(Pr,{}):e===S.WEEKLY?(0,Y.jsx)(Xr,{}):e===S.MONTHLY?(0,Y.jsx)(Jr,{}):e===S.YEARLY?(0,Y.jsx)(ei,{}):null},ni=(e,t,n)=>{(0,T.useEffect)(()=>{if(!e)return;let r=e=>{let r=e.target;t.some(e=>e.current?.contains(r))||n()},i=e=>{e.key===`Escape`&&n()};return window.addEventListener(`mousedown`,r),window.addEventListener(`keydown`,i),()=>{window.removeEventListener(`mousedown`,r),window.removeEventListener(`keydown`,i)}},[e,n,t])},ri=p.div`
  margin-top: 22px;
  padding-top: 18px;
...
`,Ti=()=>{let{rrule:e}=O(q.state),t=(0,T.useMemo)(Be,[]),n=e?me(e,{forceset:!0}).all((e,t)=>t<10).map(e=>`${v(c(e),`yyyy-MM-dd HH:mm`)} [${ge(e)}]`):[];return(0,Y.jsxs)(wi,{children:[(0,Y.jsx)(Ci,{}),t&&(0,Y.jsxs)(`code`,{children:[(0,Y.jsx)(`pre`,{children:e}),(0,Y.jsx)(`pre`,{children:JSON.stringify(n,null,2)})]})]})},Ei=(e,t)=>{let{start:n,end:r,until:i,timezone:a,allDay:o,rrule:s,repeatType:c,repeatEndType:l}=e.getState().event;$(t,`start`,Di(n)),$(t,`end`,Di(r)),$(t,`until`,i?Di(i):``),$(t,`timezone`,a||`UTC`),$(t,`allDay`,o?`1`:`0`),$(t,`repeatType`,c??`NEVER`),$(t,`repeatEndType`,l??`NEVER`),$(t,`rrule`,s??``)},Di=e=>v(o(e),`yyyy-MM-dd'T'HH:mm:ss`),$=(e,t,n)=>{let r=e.querySelector(`input[name="${t}"]`);if(!r)return;let i=n.toString();r.value!==i&&(r.value=i,r.dispatchEvent(new Event(`input`,{bubbles:!0})),r.dispatchEvent(new Event(`change`,{bubbles:!0})))},Oi=new Set([`DAILY`,`WEEKLY`,`MONTHLY`,`YEARLY`,`CUSTOM`,`NEVER`]),ki=new Set([`NEVER`,`AFTER`,`ON_DATE`]),Ai=e=>{if(!e)return{};let t=Array.isArray(e)?e:[e],n=[],r=new Set;return t.forEach(e=>{if(typeof e==`number`){n.push(e);return}n.push(e.weekday),typeof e.n==`number`&&r.add(e.n)}),{byweekday:n.length?n:void 0,bysetpos:r.size?Array.from(r):void 0}},ji=e=>Oi.has(e)?e:`NEVER`,Mi=e=>ki.has(e)?e:`NEVER`,Ni=e=>{let t=he(e.event.rrule),{byweekday:n,bysetpos:r}=Ai(t?.options.byweekday),i={app:e.app,event:{start:e.event.start,end:e.event.end,until:e.event.until,timezone:e.event.timezone,allDay:e.event.allDay,repeatType:ji(e.event.repeatType),repeatEndType:Mi(e.event.repeatEndType),rrule:e.event.rrule,freq:t?.options.freq||S.DAILY,interval:t?.options.interval||1,count:t?.options.count||null,byweekday:n,bymonth:t?.options.bymonth,bymonthday:t?.options.bymonthday,byyearday:t?.options.byyearday,bysetpos:t?.options.bysetpos??r}};return xn({reducer:{app:ir,event:tr},preloadedState:i})},Pi=new WeakSet,Fi=e=>{if(Pi.has(e))return;Pi.add(e),e.dataset.eventBuilderMounted=`true`;let t=e.querySelector(`script[data-config]`),n=e.querySelector(`div[data-root]`),r=Ni(JSON.parse(t.textContent)),i=ye.createRoot(n);r.subscribe(()=>{Ei(r,e)}),Ei(r,e),i.render((0,Y.jsx)(Me,{store:r,children:(0,Y.jsx)(Ti,{})}))},Ii=(e=document)=>{e.querySelectorAll(`[data-event-builder]:not([data-event-builder-mounted])`).forEach(Fi)},Li=()=>{Ii(),new MutationObserver(e=>{e.forEach(e=>{e.addedNodes.forEach(e=>{e instanceof HTMLElement&&(e.matches(`[data-event-builder]`)&&Fi(e),Ii(e))})})}).observe(document.documentElement,{childList:!0,subtree:!0})};document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Li):Li();