...
`,Y=f(),kr=8,Ar=()=>{let e=D(),t=O(q.state),{repeatType:n,start:r,rrule:a}=t,[o,s]=(0,T.useState)(null),c=(0,T.useMemo)(()=>_r(a,r),[a,r]),l=(0,T.useMemo)(()=>yr(c,o),[c,o]),u=(0,T.useMemo)(()=>br(c,o?.start??null,kr),[c,o]),d=(0,T.useCallback)((n,r,i)=>{e(K.setRRule(xr(t,c,n,r,i)))},[e,c,t]),f=(0,T.useCallback)(e=>{let t=vr(c,e);if(t.base&&t.excluded){d(`exdate`,t.timestamp,!1);return}if(t.base&&t.full&&n!==`NEVER`){d(`exdate`,t.timestamp,!0);return}if(!t.base&&t.full&&t.rdate){d(`rdate`,t.timestamp,!1);return}t.full||d(`rdate`,t.timestamp,!0)},[d,c,n]),p=(0,T.useCallback)(e=>vr(c,e),[c]);return(0,Y.jsxs)(Tr,{children:[(0,Y.jsx)(ae,{label:`Recurrence Preview`,children:(0,Y.jsx)(le,{aspectRatio:2,height:250,expandRows:!1,themeSystem:`bootstrap5`,plugins:[ce,ue],initialView:`dayGridMonth`,timeZone:`UTC`,eventDisplay:`none`,events:l,headerToolbar:{start:`title`,end:`prev,today,next`},datesSet:e=>s({start:e.start,end:e.end}),dayCellClassNames:e=>{let t=p(e.date);return[t.full?`fc-has-event`:``,t.rdate?`fc-extra-date`:``,t.excluded?`fc-excluded-date`:``].filter(Boolean)},dateClick:e=>f(e.date)})}),(0,Y.jsx)(Er,{children:u.length===0?(0,Y.jsxs)(`p`,{children:[x(`No occurrences starting from`),(0,Y.jsx)(`br`,{}),v(o?.start||new Date,`PP`)]}):(0,Y.jsx)(Dr,{$count:u.length,children:u.map(e=>{let t=i(new Date(e*1e3));return(0,Y.jsx)(Or,{children:t},t)})})})]})},jr=p.div`
...
`,Mr=e=>{if(!e.trim())return null;let t=Number(e);return Number.isFinite(t)?Math.trunc(t):null},Nr=({inputValue:e,value:t,min:n})=>{let r=Mr(e)??n??t??0;return n===void 0?r:Math.max(r,n)},Pr=({value:e,min:t,debounceMs:n,onChange:r})=>{let[i,a]=(0,T.useState)(e?.toString()??``),o=(0,T.useRef)(void 0),s=(0,T.useCallback)(()=>{o.current!==void 0&&(window.clearTimeout(o.current),o.current=void 0)},[]),c=(0,T.useCallback)((e,t=`debounced`)=>{if(s(),r){if(!n||t===`immediate`){r(e);return}o.current=window.setTimeout(()=>{o.current=void 0,r(e)},n)}},[s,n,r]);return(0,T.useEffect)(()=>{a(e?.toString()??``)},[e]),(0,T.useEffect)(()=>s,[s]),{inputValue:i,handleChange:(0,T.useCallback)(e=>{e.stopPropagation();let n=e.currentTarget.value;a(n);let r=Mr(n);if(r===null||t!==void 0&&r<t){s();return}c(r)},[s,c,t]),handleBlur:(0,T.useCallback)(n=>{n.stopPropagation();let r=Nr({inputValue:i,value:e,min:t});a(r.toString()),c(r,`immediate`)},[c,i,t,e])}},Fr=({value:e,min:t,debounceMs:n,onChange:r,...i})=>{let{inputValue:a,handleChange:o,handleBlur:s}=Pr({value:e,min:t,debounceMs:n,onChange:r});return(0,Y.jsx)(ae,{...i,children:(0,Y.jsx)(`input`,{type:`number`,className:`text number`,min:t,step:1,value:a,onChange:o,onBlur:s})})},Ir=e=>(0,Y.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 640 640`,fill:`currentColor`,"aria-hidden":`true`,focusable:`false`,...e,children:(0,Y.jsx)(`path`,{d:`M297.4 470.6C309.9 483.1 330.2 483.1 342.7 470.6L534.7 278.6C547.2 266.1 547.2 245.8 534.7 233.3C522.2 220.8 501.9 220.8 489.4 233.3L320 402.7L150.6 233.4C138.1 220.9 117.8 220.9 105.3 233.4C92.8 245.9 92.8 266.2 105.3 278.7L297.3 470.7z`})}),Lr=e=>(0,Y.jsx)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 640 640`,fill:`currentColor`,"aria-hidden":`true`,focusable:`false`,...e,children:(0,Y.jsx)(`path`,{d:`M297.4 169.4C309.9 156.9 330.2 156.9 342.7 169.4L534.7 361.4C547.2 373.9 547.2 394.2 534.7 406.7C522.2 419.2 501.9 419.2 489.4 406.7L320 237.3L150.6 406.6C138.1 419.1 117.8 419.1 105.3 406.6C92.8 394.1 92.8 373.8 105.3 361.3L297.3 169.3z`})}),Rr=({noun:e=`day`})=>{let t=D(),{interval:n}=O(q.state);return(0,Y.jsxs)(zr,{children:[(0,Y.jsx)(`span`,{children:`Every`}),(0,Y.jsx)(Br,{type:`text`,className:`text`,value:n,onChange:e=>{let n=parseInt(e.target.value,10)||1;t(K.setInterval(n))}}),(0,Y.jsxs)(Vr,{children:[(0,Y.jsx)(Hr,{type:`button`,onClick:()=>t(K.setInterval(n+1)),children:(0,Y.jsx)(Lr,{})}),(0,Y.jsx)(Hr,{type:`button`,onClick:()=>t(K.setInterval(n-1)),children:(0,Y.jsx)(Ir,{})})]}),(0,Y.jsxs)(`span`,{children:[e,n>1?`s`:``]})]})},zr=p.div`
  display: flex;
  flex-direction: row;
  align-items: center;
  gap: 8px;
...
`,Ur=()=>(0,Y.jsx)(Rr,{noun:`day`}),X=[{value:`MO`,label:`Monday`,days:[C.MO.weekday]},{value:`TU`,label:`Tuesday`,days:[C.TU.weekday]},{value:`WE`,label:`Wednesday`,days:[C.WE.weekday]},{value:`TH`,label:`Thursday`,days:[C.TH.weekday]},{value:`FR`,label:`Friday`,days:[C.FR.weekday]},{value:`SA`,label:`Saturday`,days:[C.SA.weekday]},{value:`SU`,label:`Sunday`,days:[C.SU.weekday]},{value:`WD`,label:`Weekday (Mon-Fri)`,days:[C.MO.weekday,C.TU.weekday,C.WE.weekday,C.TH.weekday,C.FR.weekday]},{value:`WEK`,label:`Weekend Day (Sat/Sun)`,days:[C.SA.weekday,C.SU.weekday]}],Wr=e=>{if(!(!e||e.length===0))return Array.from(new Set(e)).sort((e,t)=>e-t)},Gr=(e,t)=>{let n=Wr(e),r=Wr(t);return!n||!r||n.length!==r.length?!1:n.every((e,t)=>e===r[t])},Kr=(e,t)=>{if(e){let t=X.find(t=>Gr(t.days,e));if(t)return t.value}if(t!==void 0){let e=X.find(e=>e.days.length===1&&e.days[0]===t);if(e)return e.value}return X[0].value},qr=e=>X.find(t=>t.value===e)?.days??[C.MO.weekday],Z=`5px`,Q=p.button`
  width: 100%;
  padding: 0.5rem;
...
`,ei=({label:e,values:t,onChange:n})=>(0,Y.jsx)(ae,{label:e,children:(0,Y.jsxs)(Zr,{children:[Array.from({length:31},(e,t)=>t+1).map(e=>(0,Y.jsx)(Jr,{type:`button`,className:y(t.includes(e)&&`active`),onClick:()=>{let r=t.filter(t=>t!==e);t.includes(e)||(r=[...r,e]),r.length!==0&&(r.sort((e,t)=>e-t),n(r))},children:e},e)),Array.from({length:4},(e,t)=>t+1).map(e=>(0,Y.jsx)(Yr,{},e))]})}),ti=[{value:`MONTHDAY`,label:`On day of month`},{value:`WEEKDAY`,label:`On the nth weekday`}],ni=[{value:1,label:`First`},{value:2,label:`Second`},{value:3,label:`Third`},{value:4,label:`Fourth`},{value:-1,label:`Last`}],ri=()=>{let e=D(),{start:t,bymonthday:n,byweekday:r,bysetpos:i}=O(q.state),a=o(t),s=a.getDate(),c=(a.getDay()+6)%7,l=i?.length&&r?.length?`WEEKDAY`:`MONTHDAY`,u=n?.length?n:[s],d=i?.[0]??1,f=Kr(r,c),p=t=>{e(K.setByRules({bymonthday:t.length?t:void 0,byweekday:void 0,bysetpos:void 0}))},m=(t,n)=>{e(K.setByRules({bymonthday:void 0,byweekday:qr(t),bysetpos:[n]}))};return(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(Rr,{noun:`month`}),(0,Y.jsx)(`div`,{className:`field`,children:(0,Y.jsx)(w,{label:`Repeat On`,value:l,options:ti,onChange:e=>{e===`WEEKDAY`?m(f,d):p(u)}})}),l===`MONTHDAY`&&(0,Y.jsx)(ei,{label:`Days of month`,values:u,onChange:e=>p(e)}),l===`WEEKDAY`&&(0,Y.jsxs)(oe,{className:`field`,children:[(0,Y.jsx)(w,{label:`Position`,value:d,options:ni,onChange:e=>m(f,Number.parseInt(e,10))}),(0,Y.jsx)(w,{label:`Day`,value:f,options:X.map(e=>({value:e.value,label:e.label})),onChange:e=>m(e,d)})]})]})},ii=[C.MO,C.TU,C.WE,C.TH,C.FR,C.SA,C.SU],ai=()=>{let e=D(),{byweekday:t}=O(q.state);return(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(Rr,{noun:`week`}),(0,Y.jsx)(Qr,{className:`field`,children:ii.map(n=>(0,Y.jsx)(Jr,{type:`button`,className:y(t?.includes(n.weekday)&&`active`),onClick:()=>{let r=t?[...t]:[];r.includes(n.weekday)?r=r.filter(e=>e!==n.weekday):r.push(n.weekday),r.length!==0&&e(K.setDays({type:`byweekday`,values:r}))},children:n.toString()},n.weekday))})]})},oi=[{value:`MONTHDAY`,label:`On specific date`},{value:`WEEKDAY`,label:`On the nth weekday`}],si=[{value:1,label:`First`},{value:2,label:`Second`},{value:3,label:`Third`},{value:4,label:`Fourth`},{value:-1,label:`Last`}],ci=[{value:1,label:`January`},{value:2,label:`February`},{value:3,label:`March`},{value:4,label:`April`},{value:5,label:`May`},{value:6,label:`June`},{value:7,label:`July`},{value:8,label:`August`},{value:9,label:`September`},{value:10,label:`October`},{value:11,label:`November`},{value:12,label:`December`}],li=()=>{let e=D(),{start:t,bymonth:n,bymonthday:r,byweekday:i,bysetpos:a}=O(q.state),s=o(t),c=s.getDate(),l=s.getMonth()+1,u=(s.getDay()+6)%7,d=a?.length&&i?.length?`WEEKDAY`:`MONTHDAY`,f=r?.length?r:[c],p=n?.length?n:[l],m=a?.[0]??1,h=Kr(i,u),g=(t,n)=>{e(K.setByRules({bymonth:t.length?t:void 0,bymonthday:n.length?n:void 0,byweekday:void 0,bysetpos:void 0}))},_=(t,n,r)=>{e(K.setByRules({bymonth:t.length?t:void 0,bymonthday:void 0,byweekday:qr(n),bysetpos:[r]}))};return(0,Y.jsxs)(`div`,{children:[(0,Y.jsx)(Rr,{noun:`year`}),(0,Y.jsx)(ae,{label:`Month`,children:(0,Y.jsx)($r,{children:ci.map(e=>{let t=p.includes(e.value);return(0,Y.jsx)(Jr,{type:`button`,className:y(t&&`active`),onClick:()=>{let n=p.filter(t=>t!==e.value);t||(n=[...n,e.value]),n.length!==0&&(n.sort((e,t)=>e-t),d===`WEEKDAY`?_(n,h,m):g(n,f))},children:e.label},e.value)})})}),(0,Y.jsx)(`div`,{className:`field`,children:(0,Y.jsx)(w,{label:`Repeat On`,value:d,options:oi,onChange:e=>{e===`WEEKDAY`?_(p,h,m):g(p,f)}})}),d===`MONTHDAY`&&(0,Y.jsx)(ei,{label:`Days of month`,values:f,onChange:e=>g(p,e)}),d===`WEEKDAY`&&(0,Y.jsxs)(oe,{className:`field`,children:[(0,Y.jsx)(w,{label:`Position`,value:m,options:si,onChange:e=>_(p,h,Number.parseInt(e,10))}),(0,Y.jsx)(w,{label:`Day`,value:h,options:X.map(e=>({value:e.value,label:e.label})),onChange:e=>_(p,e,m)})]})]})},ui=()=>{let{freq:e}=O(q.state);return e===S.DAILY?(0,Y.jsx)(Ur,{}):e===S.WEEKLY?(0,Y.jsx)(ai,{}):e===S.MONTHLY?(0,Y.jsx)(ri,{}):e===S.YEARLY?(0,Y.jsx)(li,{}):null},di=(e,t,n)=>{(0,T.useEffect)(()=>{if(!e)return;let r=e=>{let r=e.target;t.some(e=>e.current?.contains(r))||n()},i=e=>{e.key===`Escape`&&n()};return window.addEventListener(`mousedown`,r),window.addEventListener(`keydown`,i),()=>{window.removeEventListener(`mousedown`,r),window.removeEventListener(`keydown`,i)}},[e,n,t])},fi=p.div`
  margin-top: 22px;
  padding-top: 18px;
...
`,Ci=({title:e,actionLabel:t,actionClass:n,popoverTitle:r,dates:i,openToDate:a,weekStartDay:o,formatDate:c,filterDate:l,onAdd:u,onRemove:d})=>{let[f,p]=(0,T.useState)(!1),h=(0,T.useRef)(null),_=(0,T.useRef)(null);return(0,T.useEffect)(()=>{i.length===0&&p(!1)},[i.length]),di(f,[h,_],()=>p(!1)),(0,Y.jsxs)(fi,{children:[(0,Y.jsx)(pi,{children:x(e)}),(0,Y.jsxs)(mi,{children:[(0,Y.jsxs)(_i,{children:[(0,Y.jsx)(vi,{ref:h,type:`button`,disabled:i.length===0,className:y({active:f}),onClick:()=>{i.length!==0&&p(e=>!e)},children:i.length}),f&&(0,Y.jsxs)(yi,{ref:_,children:[(0,Y.jsx)(bi,{children:x(r)}),(0,Y.jsx)(xi,{children:i.map(e=>(0,Y.jsxs)(Si,{children:[(0,Y.jsx)(`span`,{children:c(e)}),(0,Y.jsx)(`button`,{type:`button`,onClick:()=>d(e),children:`×`})]},e))})]})]}),(0,Y.jsx)(hi,{children:(0,Y.jsx)(g,{selected:null,onChange:e=>{e&&u(s(m(e)))},customInput:(0,Y.jsx)(wi,{label:t,className:y(`btn`,n)}),shouldCloseOnSelect:!0,showTimeSelect:!1,showMonthDropdown:!0,showYearDropdown:!0,dropdownMode:`select`,todayButton:x(`Today`),openToDate:a,calendarStartDay:o,filterDate:l})})]})]})},wi=(0,T.forwardRef)(({label:e,...t},n)=>(0,Y.jsx)(gi,{type:`button`,ref:n,...t,children:x(e)}));wi.displayName=`PickerTrigger`;var Ti=p.div`
  flex: 1;
`,Ei=()=>{let e=D(),t=O(q.state),{start:n,rrule:r}=t,i=(0,T.useMemo)(()=>s(m(o(n))),[n]),u=(0,T.useMemo)(()=>he(r)??null,[r]),d=(0,T.useMemo)(()=>pe(r),[r]),f=(0,T.useMemo)(()=>d?Array.from(new Set(d.rdates().map(e=>s(m(c(e)))).filter(e=>u?!0:e!==i))).sort((e,t)=>e-t):[],[u,d,i]),p=(0,T.useMemo)(()=>d?Array.from(new Set(d.exdates().map(e=>s(m(c(e)))))).sort((e,t)=>e-t):[],[d]),h=(0,T.useMemo)(()=>new Set(f),[f]),g=(0,T.useMemo)(()=>new Set(p),[p]),_=(0,T.useCallback)(e=>{let t=a(m(e)),n=l(ne(e)),r=u?u.between(t,n,!0).length>0:!1,o=d?d.between(t,n,!0).length>0:s(m(e))===i;return{full:o,base:r,excluded:r&&!o}},[u,d,i]),v=n=>{let r=n({baseRule:u,rdates:d?.rdates().filter(e=>u?!0:s(m(c(e)))!==i)??[],exdates:d?.exdates()??[]});e(K.setRRule(Kn(t,r.baseRule,Di(r.rdates),Di(r.exdates))))};return{addedDates:f,excludedDates:p,addFixedDate:(e,n)=>{let r=Gn(t,n);v(({baseRule:t,rdates:n,exdates:i})=>({baseRule:t,rdates:e===`rdate`?[...n,r]:n,exdates:e===`exdate`?[...i,r]:i}))},removeFixedDate:(e,n)=>{let r=Gn(t,n).getTime();v(({baseRule:t,rdates:n,exdates:i})=>({baseRule:t,rdates:e===`rdate`?n.filter(e=>e.getTime()!==r):n,exdates:e===`exdate`?i.filter(e=>e.getTime()!==r):i}))},canAddOccurrence:(0,T.useCallback)(e=>{let t=s(m(e)),n=_(e);return!n.full&&!n.excluded&&!h.has(t)},[h,_]),canExcludeOccurrence:(0,T.useCallback)(e=>{let t=s(m(e)),n=_(e);return n.base&&!n.excluded&&!g.has(t)},[g,_]),getStatus:_}},Di=e=>{let t=new Map(e.map(e=>[e.getTime(),e])).values();return Array.from(t).sort((e,t)=>e.getTime()-t.getTime())},Oi=[{value:`NEVER`,label:`Never`},{value:`DAILY`,label:`Every Day`},{value:`WEEKLY`,label:`Every Week`},{value:`MONTHLY`,label:`Every Month`},{value:`YEARLY`,label:`Every Year`},{value:`CUSTOM`,label:`Custom...`}],ki=[{value:`NEVER`,label:`Never`},{value:`AFTER`,label:`After...`},{value:`ON_DATE`,label:`On Date...`}],Ai=[{value:S.DAILY,label:`Daily`},{value:S.WEEKLY,label:`Weekly`},{value:S.MONTHLY,label:`Monthly`},{value:S.YEARLY,label:`Yearly`}],ji=300,Mi=()=>{let e=D(),t=O(q.state),n=O(J.weekStartDay),{repeatType:r,repeatEndType:i,count:a,until:s,freq:c,start:l}=t,u=r!==`NEVER`,{addedDates:d,excludedDates:f,addFixedDate:p,removeFixedDate:m,canAddOccurrence:g,canExcludeOccurrence:_}=Ei(),ee=(0,T.useMemo)(()=>o(l),[l]),te=e=>v(o(e),`yyyy-MM-dd`);return(0,Y.jsxs)(Ti,{children:[(0,Y.jsxs)(oe,{children:[(0,Y.jsx)(w,{label:`Repeat`,value:r,options:Oi,onChange:t=>e(K.setRepeatType(t))}),r===`CUSTOM`&&(0,Y.jsx)(w,{label:``,value:c,options:Ai,onChange:t=>e(K.setFreq(Number.parseInt(t,10)))})]}),r===`CUSTOM`&&(0,Y.jsx)(`div`,{className:`field`,children:(0,Y.jsx)(ui,{})}),r!==`NEVER`&&(0,Y.jsxs)(oe,{className:`field`,children:[(0,Y.jsx)(w,{label:`Repeat End`,options:ki,value:i,onChange:t=>e(K.setRepeatEndType(t))}),i===`AFTER`&&(0,Y.jsx)(Fr,{label:`Times`,value:a,min:1,debounceMs:ji,onChange:t=>e(K.setCount(t))}),i===`ON_DATE`&&(0,Y.jsx)(h,{label:``,value:s||null,onChange:t=>e(K.setUntil(t)),datePickerProps:{showTimeInput:!1,calendarStartDay:n}})]}),(0,Y.jsx)(Ci,{title:`Custom Occurrences`,actionLabel:`Add Occurrence`,actionClass:`icon add dashed`,popoverTitle:`Added Occurrences`,dates:d,openToDate:ee,formatDate:te,filterDate:g,weekStartDay:n,onAdd:e=>p(`rdate`,e),onRemove:e=>m(`rdate`,e)}),u&&(0,Y.jsx)(Ci,{title:`Exceptions`,actionLabel:`Exclude Occurrence`,actionClass:`icon dashed minus`,popoverTitle:`Excluded Occurrences`,dates:f,openToDate:ee,formatDate:te,filterDate:_,weekStartDay:n,onAdd:e=>p(`exdate`,e),onRemove:e=>m(`exdate`,e)})]})},Ni=()=>{let e=(0,T.useId)(),t=(0,T.useId)(),n=(0,T.useId)(),r=D(),{start:i,end:a,allDay:c}=O(q.state),{date:l,time:u,datetime:d}=O(J.formats),f=O(J.weekStartDay),p=O(J.timeInterval),g=O(J.eventDuration),v=(0,T.useMemo)(()=>c?l.short.icu:d.short.icu,[c,l,d]),ee=(0,T.useMemo)(()=>c?s(_(o(a),1)):a,[c,a]);return(0,Y.jsxs)(jr,{children:[(0,Y.jsxs)(`div`,{style:{flex:1},children:[(0,Y.jsx)(re,{id:e,label:`All Day`,enabled:c,onClick:e=>r(K.setAllDay({enabled:e,eventDuration:g}))}),(0,Y.jsx)(h,{id:t,label:`Starts`,value:i,onChange:e=>r(K.setStart(e)),datePickerProps:{id:t,showIcon:!0,icon:(0,Y.jsx)(ie,{}),toggleCalendarOnIconClick:!0,showTimeSelect:!c,showMonthDropdown:!0,showYearDropdown:!0,dropdownMode:`select`,dateFormat:v,timeFormat:u.short.icu,todayButton:x(`Today`),calendarStartDay:f,timeIntervals:p}}),(0,Y.jsx)(h,{id:n,label:`Ends`,value:ee,onChange:e=>{if(e==null)return;if(!c){r(K.setEnd(e));return}let t=se(m(o(e)),1);r(K.setEnd(s(t)))},datePickerProps:{id:n,showIcon:!0,icon:(0,Y.jsx)(ie,{}),toggleCalendarOnIconClick:!0,minDate:o(i),showTimeSelect:!c,showMonthDropdown:!0,showYearDropdown:!0,dropdownMode:`select`,dateFormat:v,timeFormat:u.short.icu,todayButton:x(`Today`),calendarStartDay:f,timeIntervals:p,filterTime:e=>{if(!i)return!0;let t=o(i),n=new Date(e);return t.getTime()<n.getTime()}}})]}),(0,Y.jsx)(Mi,{}),(0,Y.jsx)(Ar,{})]})},Pi=p.div`
  code {
    display: block;
    padding: 12px;
    background-color: var(--gray-100);
...
`,Fi=()=>{let{rrule:e}=O(q.state),t=(0,T.useMemo)(Be,[]),n=e?me(e,{forceset:!0}).all((e,t)=>t<10).map(e=>`${v(c(e),`yyyy-MM-dd HH:mm`)} [${ge(e)}]`):[];return(0,Y.jsxs)(Pi,{children:[(0,Y.jsx)(Ni,{}),t&&(0,Y.jsxs)(`code`,{children:[(0,Y.jsx)(`pre`,{children:e}),(0,Y.jsx)(`pre`,{children:JSON.stringify(n,null,2)})]})]})},Ii=(e,t)=>{let{start:n,end:r,until:i,timezone:a,allDay:o,rrule:s,repeatType:c,repeatEndType:l}=e.getState().event;$(t,`start`,Li(n)),$(t,`end`,Li(r)),$(t,`until`,i?Li(i):``),$(t,`timezone`,a||`UTC`),$(t,`allDay`,o?`1`:`0`),$(t,`repeatType`,c??`NEVER`),$(t,`repeatEndType`,l??`NEVER`),$(t,`rrule`,s??``)},Li=e=>v(o(e),`yyyy-MM-dd'T'HH:mm:ss`),$=(e,t,n)=>{let r=e.querySelector(`input[name="${t}"]`);if(!r)return;let i=n.toString();r.value!==i&&(r.value=i,r.dispatchEvent(new Event(`input`,{bubbles:!0})),r.dispatchEvent(new Event(`change`,{bubbles:!0})))},Ri=e=>{let t=he(e.event.rrule),{byweekday:n,bysetpos:r}=nr(t?.options.byweekday),i=rr(e.event.repeatType),a=ir(e.event.repeatEndType),o={app:e.app,event:{start:e.event.start,end:e.event.end,until:e.event.until,timezone:e.event.timezone,allDay:e.event.allDay,repeatType:i,repeatEndType:a,rrule:e.event.rrule,freq:t?.options.freq||S.DAILY,interval:t?.options.interval||1,count:a===`AFTER`?ar(t?.options.count):t?.options.count||null,byweekday:n,bymonth:t?.options.bymonth,bymonthday:t?.options.bymonthday,byyearday:t?.options.byyearday,bysetpos:t?.options.bysetpos??r}};return xn({reducer:{app:ur,event:sr},preloadedState:o})},zi=new WeakSet,Bi=e=>{if(zi.has(e))return;zi.add(e),e.dataset.eventBuilderMounted=`true`;let t=e.querySelector(`script[data-config]`),n=e.querySelector(`div[data-root]`),r=Ri(JSON.parse(t.textContent)),i=ye.createRoot(n);r.subscribe(()=>{Ii(r,e)}),Ii(r,e),i.render((0,Y.jsx)(Me,{store:r,children:(0,Y.jsx)(Fi,{})}))},Vi=(e=document)=>{e.querySelectorAll(`[data-event-builder]:not([data-event-builder-mounted])`).forEach(Bi)},Hi=()=>{Vi(),new MutationObserver(e=>{e.forEach(e=>{e.addedNodes.forEach(e=>{e instanceof HTMLElement&&(e.matches(`[data-event-builder]`)&&Bi(e),Vi(e))})})}).observe(document.documentElement,{childList:!0,subtree:!0})};document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Hi):Hi();