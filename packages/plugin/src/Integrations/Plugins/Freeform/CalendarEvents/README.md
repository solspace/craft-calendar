...
This integration allows you to map Freeform submission data to [Calendar](https://docs.solspace.com/craft/calendar/v3). In addition to most custom Craft fields, Freeform can also map to the *Title*, *Site ID*, *Slug*, *Author ID*, *Post Date*, *Date Created* and *Date Updated*.
